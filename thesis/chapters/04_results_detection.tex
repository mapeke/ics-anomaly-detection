\section{Same-dataset detection and metric sensitivity}
...
\subsection{Full detection grid}
...
\subsection{Ranking changes across metrics}
...
\subsection{PA-F1 inflation on classical detectors}
...
\subsection{USAD collapse on Morris}
...
\subsection{HAI LSTM-AE reproducibility check}
...
\subsection{HAI TranAD reproducibility check}
